    ...
    public partial class FormAdd : Form
    {
        ...
        private void BtnAccept_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                (lp, symbol_wykaz_akt, tytul, dat_pocz, dat_konc, ltomow, uwagi, dodat_info, lat_waz)
                VALUES(@lp , @sWa , @tyt , @dat_pocz , @dat_konc , @ltomow , @uwagi , @dodat , @lat_waz)";

                if (tbSDate.Text.Replace(" ","").Equals("--"))
                {
                    sql = @"INSERT INTO archiwum.archiwum
                    (lp, symbol_wykaz_akt, tytul, dat_pocz, dat_konc, ltomow, uwagi, dodat_info, lat_waz )
                    VALUES(@lp , @sWa , @tyt , NULL , @dat_konc , @ltomow , @uwagi , @dodat , @lat_waz)";
                }
                if (tbEDate.Text.Replace(" ", "").Equals("--"))
                {
                    sql = @"INSERT INTO archiwum.archiwum
                    (lp, symbol_wykaz_akt, tytul, dat_pocz, dat_konc, ltomow, uwagi, dodat_info, lat_waz )
                    VALUES(@lp , @sWa , @tyt , NULL , NULL , @ltomow , @uwagi , @dodat , @lat_waz)";
                }
            ...
            catch (Exception exc)
            {
                ...
                GlobalData.Stat = "Dodawanie nieudane";
                Close();
            }
